...
import { readProcessedTeams, readRuns } from '../../../utils/database';
...
function DataContainer(props) {
	...
	return (
		<div className={classes.root}>
			{dbRead && <DataContent template={template} events={events} processedTeams={processed} rawRuns={runs.sort((a, b) => a.match - b.match)} />}
		</div>
	);
};
